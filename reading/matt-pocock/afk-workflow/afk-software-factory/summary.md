...
This summary generated by AI, from a transcript obtained by downloading auto-captions with [yt-dlp](https://github.com/yt-dlp/yt-dlp), then converting the captions file into human- and agent-friendly text with [this script](https://github.com/stewdotorg/scripts/blob/main/vtclean.py).
